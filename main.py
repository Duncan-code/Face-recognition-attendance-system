...
firebase_admin.initialize_app(cred,{
    ...
    'storageBucket': "faceattendancerealtime-54ba0.appspot.com"
})
...
while True:
    ...
    if faceCurFrame:
        ...
        if counter != 0:
            ...
            if counter ==1:
                # Get the data
                studentInfo = db.reference(f'STAFF/{id}').get()
                print(studentInfo)
            ...
            if modeType !=3:
                ...
                if counter<=10:
                    ...
                    cv2.putText(imgBackground, str(studentInfo['Years worked']), (1025, 625),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
